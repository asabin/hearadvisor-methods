...
![KEMAR manikin surrounded by 8-speaker ring in the HearAdvisor acoustic test lab](../assets/lab-photo.jpg)
...
We used the reverberation time and room volume to estimate the critical distance (the distance at which the direct and reverberant signals have equal levels)[[1]](references.md).

![Test lab floorplan](../assets/lab-floorplan.svg)
