...
Both components are bounded below at 1.0 before averaging, so the published score does not distinguish among devices at the extreme low end of the scale. There is no upper bound: a device with strong benefit can score above 5.
